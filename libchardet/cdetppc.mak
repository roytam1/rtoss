...
!MESSAGE 
!MESSAGE NMAKE /f "cdetppc.mak" CFG="chardet_vc4 - Win32 Debug"
!MESSAGE 
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\cdetppc.dll"
	-@erase "$(OUTDIR)\cdetppc.exp"
	-@erase "$(OUTDIR)\cdetppc.lib"
...
# ADD CPP /nologo /W3 /Zi /O1 /I "src" /I "src\tables" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "DLL_EXPORTS" /YX /c
CPP_PROJ=/nologo /ML /W3 /Zi /O1 /I "src" /I "src\tables" /D\
 "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "DLL_EXPORTS" /Fp"$(INTDIR)/cdetppc.pch"\
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /dll /machine:PPC
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib\
 odbccp32.lib /nologo /subsystem:windows /dll /incremental:no\
 /pdb:"$(OUTDIR)/cdetppc.pdb" /machine:PPC /out:"$(OUTDIR)/cdetppc.dll"\
 /implib:"$(OUTDIR)/cdetppc.lib" 
LINK32_OBJS= \
...
"$(OUTDIR)\cdetppc.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/cdetppc.bsc" 
BSC32_SBRS= \
...
# PROP BASE Output_Dir "PPCDebug"
# PROP BASE Intermediate_Dir "PPCDebug"
# PROP BASE Target_Dir ""
# PROP Use_MFC 0
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\cdetppc.dll"
	-@erase "$(OUTDIR)\cdetppc.exp"
	-@erase "$(OUTDIR)\cdetppc.ilk"
	-@erase "$(OUTDIR)\cdetppc.lib"
	-@erase "$(OUTDIR)\cdetppc.pdb"
...
# ADD CPP /nologo /ML /W3 /Zi /O1 /I "src" /I "src\tables" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "DLL_EXPORTS" /YX /c
CPP_PROJ=/nologo /ML /W3 /Zi /O1 /I "src" /I "src\tables" /D\
 "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "DLL_EXPORTS" /Fp"$(INTDIR)/cdetppc.pch"\
 /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\PPCDebug/
CPP_SBRS=.\.
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/cdetppc.pdb" /debug /machine:PPC\
 /out:"$(OUTDIR)/cdetppc.dll" /implib:"$(OUTDIR)/cdetppc.lib" 
LINK32_OBJS= \
	"$(INTDIR)\CharDistribution.obj" \
	"$(INTDIR)\impl.obj" \
	"$(INTDIR)\JpCntx.obj" \
