...
!IF "$(CFG)" == ""
CFG=cdetaxp - Win32 Release
!MESSAGE No configuration specified.  Defaulting to cdetaxp - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "cdetaxp - Win32 Release" && "$(CFG)" !=\
 "cdetaxp - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "cdetaxp.mak" CFG="cdetaxp - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "cdetaxp - Win32 Release" (based on\
 "Win32 (ALPHA) Dynamic-Link Library")
!MESSAGE "cdetaxp - Win32 Debug" (based on\
 "Win32 (ALPHA) Dynamic-Link Library")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "cdetaxp - Win32 Debug"
MTL=mktyplib.exe
CPP=cl.exe
RSC=rc.exe
F90=fl32.exe

!IF  "$(CFG)" == "cdetaxp - Win32 Release"
...
CLEAN : 
	...
	-@erase "$(INTDIR)\nsUTF8Prober.obj"
	-@erase "$(OUTDIR)\cdetaxp.dll"
	-@erase "$(OUTDIR)\cdetaxp.exp"
	-@erase "$(OUTDIR)\cdetaxp.lib"
...
# ADD F90 /I "AxpRel/"
F90_OBJS=.\AxpRel/
# ADD BASE CPP /nologo /MT /W3 /GX /Gt0 /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /YX /c
# ADD CPP /nologo /MT /W3 /GX /Gt0 /O2 /I "src" /I "src\tables" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "DLL_EXPORTS" /YX /c
CPP_PROJ=/nologo /MT /W3 /GX /Gt0 /O2 /I "src" /I "src\tables" /D "NDEBUG" /D\
 "WIN32" /D "_WINDOWS" /D "DLL_EXPORTS" /Fp"$(INTDIR)/cdetaxp.pch" /YX\
 /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\AxpRel/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/cdetaxp.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/cdetaxp.pdb" /machine:ALPHA /out:"$(OUTDIR)/cdetaxp.dll"\
 /implib:"$(OUTDIR)/cdetaxp.lib" 
LINK32_OBJS= \
...
"$(OUTDIR)\cdetaxp.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "cdetaxp - Win32 Debug"
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\cdetaxp.dll"
	-@erase "$(OUTDIR)\cdetaxp.exp"
	-@erase "$(OUTDIR)\cdetaxp.ilk"
	-@erase "$(OUTDIR)\cdetaxp.lib"
	-@erase "$(OUTDIR)\cdetaxp.pdb"
...
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /Zi /Od /I "src" /I "src\tables" /D "_DEBUG"\
 /D "WIN32" /D "_WINDOWS" /D "DLL_EXPORTS" /Fp"$(INTDIR)/cdetaxp.pch" /YX\
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/cdetaxp.pdb" /debug /machine:ALPHA\
 /out:"$(OUTDIR)/cdetaxp.dll" /implib:"$(OUTDIR)/cdetaxp.lib" 
LINK32_OBJS= \
	"$(INTDIR)\CharDistribution.obj" \
	"$(INTDIR)\impl.obj" \
	"$(INTDIR)\JpCntx.obj" \
...
# Name "cdetaxp - Win32 Release"
# Name "cdetaxp - Win32 Debug"
