                                    ...
                                    uint32_t *private_features)
{
    if (!lookup_feature(features, flagname, NULL, feature_name) &&
        ...
        !lookup_feature(private_features, flagname, NULL, private_feature_name))
...
static int cpu_x86_find_by_name(x86_def_t *x86_cpu_def, const char *cpu_model)
{
    ...
    uint32_t plus_private_features = 0;
    /* Features to be removed */
    uint32_t minus_features = 0, minus_ext_features = 0;
    uint32_t minus_ext2_features = 0, minus_ext3_features = 0;
    uint32_t minus_kvm_features = 0, minus_svm_features = 0;
    uint32_t minus_private_features = 0;
    uint32_t numvalue;
    ...
    add_flagname_to_bitmaps("hypervisor", &plus_features,
        ...
        &plus_kvm_features, &plus_svm_features, &plus_private_features);
    ...
    while (featurestr) {
        ...
        if (featurestr[0] == '+') {
            add_flagname_to_bitmaps(featurestr + 1, &plus_features,
                            ...
                            &plus_svm_features, &plus_private_features);
        } else if (featurestr[0] == '-') {
            add_flagname_to_bitmaps(featurestr + 1, &minus_features,
                            &minus_ext_features, &minus_ext2_features,
                            &minus_ext3_features, &minus_kvm_features,
                            &minus_svm_features, &minus_private_features);
