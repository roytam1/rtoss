                                       ...
                                       const int8_t c, const int8_t d)
{
    if (a == 'm')
    {
        ...
        if (mp4ff_atom_compare(a,b,c,d, (char)0xA9,'n','a','m'))
            return ATOM_TITLE;
        else if (mp4ff_atom_compare(a,b,c,d, (char)0xA9,'A','R','T'))
            return ATOM_ARTIST;
        else if (mp4ff_atom_compare(a,b,c,d, (char)0xA9,'w','r','t'))
            return ATOM_WRITER;
        else if (mp4ff_atom_compare(a,b,c,d, (char)0xA9,'a','l','b'))
            return ATOM_ALBUM;
        else if (mp4ff_atom_compare(a,b,c,d, (char)0xA9,'d','a','y'))
            return ATOM_DATE;
        else if (mp4ff_atom_compare(a,b,c,d, (char)0xA9,'t','o','o'))
            return ATOM_TOOL;
        else if (mp4ff_atom_compare(a,b,c,d, (char)0xA9,'c','m','t'))
            return ATOM_COMMENT;
        else if (mp4ff_atom_compare(a,b,c,d, (char)0xA9,'g','e','n'))
            return ATOM_GENRE1;
    }
